...
public class LLPhotosPickerCtrl: UIViewController {
   ...
   var tableView: UITableView!
    ...
    private func setupUI() {
        ...
        self.tableView.register(LLPhotosPickerCell.classForCoder(), forCellReuseIdentifier: "cell")
    ...
    private func requestAlbums() {
        ...
        PHPhotoLibrary.requestAuthorization { (status) in
            ...
            DispatchQueue.main.async {
                ...
                let imageCollectionCtrl = LLPhotosCollectionCtrl()
...
extension LLPhotosPickerCtrl:UITableViewDelegate,UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        imageCollectionCtrl.completeHandler = self.completeHandler
        // 设置标题
        imageCollectionCtrl.title = item.title
        // 设置最多可选择图片的数量
        imageCollectionCtrl.maxCount = self.maxSelected
        // 获取到选中相簿信息
        ...
        self.navigationController?.pushViewController(imageCollectionCtrl, animated: true)
    }
}
