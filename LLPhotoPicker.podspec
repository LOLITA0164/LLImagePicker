Pod::Spec.new do |s|
	...
	s.source_files  		= 'LLPhotosPicker/LLPhotosPicker/*.{swift}'
	s.resources  			= 'LLPhotosPicker/LLPhotosPicker/*.{xcassets,storyboard}'
	s.swift_version 		= '4.2'
	s.frameworks    		= 'UIKit', 'Foundation', 'Photos'
	s.dependency 'SnapKit'
	s.subspec 'public' do |ss|
		ss.source_files  		= 'LLPhotosPicker/LLPhotosPicker/public/*.{swift}'
	end
end
